...
export default function Menu() {
  ...
  return (
    <section id="menu" ref={ref} className="py-24 md:py-36 bg-cream-50">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((cat, i) => (
            <motion.div
              ...
              className="border border-dark-900/10 p-6 hover:border-lina-500/50 transition-colors bg-white"
            >
              <h3 className="font-display font-black text-base uppercase tracking-wide text-lina-500 mb-4">
                {cat.label}
              </h3>
