  ...
  return (
    <section id="bebidas" ref={ref} className="py-24 md:py-36 bg-dark-800 overflow-hidden">
      <div className="container-custom">
        ...
        >
          <span className="section-label">Para Entonarse</span>
        ...
        {/* 13 drinks — same gap values as KROP FeaturedDrinks */}
          ...
          {siteConfig.signatureDrinks.map((drink, i) => (
            ...
            >
              <div className="relative w-full flex justify-center mb-8">
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-40 h-20 bg-lina-500/10 rounded-full blur-2xl" />
                <motion.img
                  src={drink.image}
                  alt={drink.name}
                  ...
                  style={{ filter: 'drop-shadow(0 20px 40px rgba(46,104,116,0.15))' }}
                />
              </div>

              <div className="w-8 h-0.5 bg-lina-500 mb-4" />
        ...
        >
          <div className="border border-lina-500/40 inline-block px-10 py-6 text-center">
